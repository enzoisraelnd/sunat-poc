// SES / notificaciones por email deshabilitadas temporalmente.
// La cuenta no tiene permisos SES habilitados.
// Para reactivar: descomentar este archivo y restaurar la llamada en onboarding-create.ts
...
export {}; // módulo vacío — sin efectos en el resto del código
